module.exports.initScrPlwNewReport = function () {
  ...
  $(function () {
    ...
    $('#showDataScrPlwReport').on('click', function (e) {
      e.preventDefault();
      var fullTextPlw = ["Province", "District", "Tehsil", "UC", "Total Catchement Population", "Total HH Visited", "Reporting Month", "Staff Name", "Staff Code", "Supervisor Name", "Supervisor Code", 'Report Type', "Total Screened (Pragnent)", "Total Screened (Lectating)","Total Screened (PLW)", "First time Screened (Pragnent)", "First time Screened (Lectating)", "First time Screened (PLW)","Re-Screened (Pragnent)", "Re-Screened (Lactating)", "Re-Screened (PLW)", "MUAC >=21 (Pragnent)", "MUAC >=21 (Lectating)", "MUAC >=21 (PLW)", "MUAC <21 (Pragnent)", "MUAC <21 (Lectating)","MUAC <21 (PLW)", "PLW Received IFA Tablets First Time (Pragnent)", "PLW Received IFA Tablets First Time (Lectating)","PLW Received IFA Tablets First Time (PLW)", "Total Follow ups", "Total Exits"];
      var colNamePlw = ["province", "district_name", "tehsil_name", "uc_name", "catchment_population", "total_hh", "report_month", "staff_name", "staff_code", "sup_name", "sup_code", 'ent_type', "total_scr_pragnent", "total_scr_lactating","total_scr_plw", "new_scr_pragnent","new_scr_lactating","new_scr_plw", "reScreened_scr_pragnent", "reScreened_scr_lactating","reScreened_scr_plw", "muac_gt_21_pragnent", "muac_gt_21_lactating","muac_gt_21_plw", "muac_le_21_pragnent", "muac_le_21_lactating","muac_le_21_plw", "ifa_first_time_pragnent", "ifa_first_time_lactating", "ifa_first_time_plw", "total_followup", "total_exits"];
      if ($('#filterDate').valid()) {
