module.exports.initScrPlwNewReport = function () {
  ...
  $(function () {
    ...
    $('#showDataScrPlwReport').on('click', function (e) {
      e.preventDefault();
      var fullTextPlw = ["Province", "District", "Tehsil", "UC", "Total Catchement Population", "Total HH Visited", "Reporting Month", "Staff Name", "Staff Code", "Supervisor Name", "Supervisor Code", 'Report Type', "Total Screened (Pragnent)", "Total Screened (Lectating)", "First time Screened (Pragnent)", "First time Screened (Lectating)", "Re-Screened (Pragnent)", "Re-Screened (Lactating)", "MUAC >=21 (Pragnent)", "MUAC >=21 (Lectating)", "MUAC <21 (Pragnent)", "MUAC <21 (Lectating)", "PLW Received IFA Tablets First Time (Pragnent)", "PLW Received IFA Tablets First Time (Lectating)", "Total Follow ups", "Total Exits"];
