...
$('#showDataScrPlwReport').on('click', function(){
  var fullTextPlw =['Province','District','Tehsil','UC','Village','Nutrition Site','Screening Date','Staff Name','Staff Code','Supervisor Name','Supervisor Code','Total Screened (Pragnent)','Total Screened (Lectating)','First time Screened (Pragnent)','First time Screened (Lectating)','MUAC >=21 (Pragnent)','MUAC >=21 (Lectating)','MUAC <21 (Pragnent)','MUAC <21 (Lectating)','IFA tablets recieved (Pragnent)','IFA tablets recieved (Lectating)']
  var colNamePlw=['province','district_name','tehsil_name','uc_name','village','site_name','screening_date','staff_name','staff_code','sup_name','sup_code','total_scr_pragnent','total_scr_lactating','new_scr_pragnent','new_scr_lactating','muac_gt_21_pragnent','muac_gt_21_lactating','muac_le_21_pragnent','muac_le_21_lactating','ifa_tabs_rec_pragnent','ifa_tabs_rec_lactating']
