module.exports.autoStock = function () {
  ...
  $('#reqBtn').on('click', (e) => {
    var req_val = ((amc_actual * 3) + (amc_actual * 0.15)).toFixed(2)
    var html = `<style>tr, th, td { border: 0.5px solid black;} table {border-collapse: collapse;}</style><p>Dear ACF Team, </p> <p>You are hereby requested to dispatch commodities as per following table</p>
