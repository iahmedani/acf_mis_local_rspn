...
function scrAddChild(){
  ...
  ipcMain.on('getProvince', function(event){
    knex('tblGeoProvince')
    .then(result=>{
      addScrChild.webContents.send('province', ({province: result}));
    })
    .catch(err=>{
      console.log(err);
    })
  ...
  ipcMain.on('getDistrict', function(event, prov){
    ...
    .then(result=>{
      addScrChild.webContents.send('district', ({district: result}));
    })
    .catch(err=>{
      console.log(err);
    })
  ...
  ipcMain.on('getTehsil', function(event, dist){
    ...
    .then(result=>{
      addScrChild.webContents.send('tehsil', ({tehsil: result}));
    })
    .catch(err=>{
      console.log(err);
    })
  ...
  ipcMain.on('getUC', function(event, tehs){
    ...
    .then(result=>{
      addScrChild.webContents.send('uc', ({uc: result}));
    })
    .catch(err=>{
      console.log(err);
    })
  ...
  ipcMain.on('getHealthHouse', function(event, ucs){
    ...
    .then(result=>{
      addScrChild.webContents.send('hh', ({hh: result}));
    })
    .catch(err=>{
      console.log(err);
    })
  ...
  ipcMain.on('getHealthHouseType', function(event, h_id){
    ...
    .then(result=>{
      addScrChild.webContents.send('hhType', ({hh: result}));
    })
    .catch(err=>{
      console.log(err);
    })
  ...
  ipcMain.on('submitFormChild', function(evenet, scrForm){
    ...
    if(data.length <1){
      knex('Screening')
        .insert(single)
        .then(result=>{
          addScrChild.webContents.send("resultSent", {'msg':'record added'});
        })
        .catch(err=>{
          addScrChild.webContents.send("resultSent", {'msg':'eror occured, plz try again'});          
        })
    } else {
      knex('Screening')
        .insert(data)
        .then(result=>{
          addScrChild.webContents.send("resultSent", {'msg':'records added'});
        })
        .catch(err=>{
          addScrChild.webContents.send("resultSent", {'msg':'eror occured, plz try again'});          
        })
...
function scrAddPlw(){
  ...
  ipcMain.on('getProvince', function(event){
    knex('tblGeoProvince')
    .then(result=>{
      addScrPlw.webContents.send('province', ({province: result}));
    })
    .catch(err=>{
      console.log(err);
    })
  ...
  ipcMain.on('getDistrict', function(event, prov){
    ...
    .then(result=>{
      addScrPlw.webContents.send('district', ({district: result}));
    })
    .catch(err=>{
      console.log(err);
    })
  ...
  ipcMain.on('getTehsil', function(event, dist){
    ...
    .then(result=>{
      addScrPlw.webContents.send('tehsil', ({tehsil: result}));
    })
    .catch(err=>{
      console.log(err);
    })
  ...
  ipcMain.on('getUC', function(event, tehs){
    ...
    .then(result=>{
      addScrPlw.webContents.send('uc', ({uc: result}));
    })
    .catch(err=>{
      console.log(err);
    })
  ...
  ipcMain.on('getHealthHouse', function(event, ucs){
    ...
    .then(result=>{
      addScrPlw.webContents.send('hh', ({hh: result}));
    })
    .catch(err=>{
      console.log(err);
    })
  ...
  ipcMain.on('getHealthHouseType', function(event, h_id){
    ...
    .then(result=>{
      addScrPlw.webContents.send('hhType', ({hh: result}));
    })
    .catch(err=>{
      console.log(err);
    })
  ...
  ipcMain.on('submitFormPlw', function(evenet, scrForm){
    ...
    if(data.length <1){
      knex('Screening')
        .insert(single)
        .then(result=>{
          addScrPlw.webContents.send("resultSent", {'msg':'record added'});
        })
        .catch(err=>{
          addScrPlw.webContents.send("resultSent", {'msg':'eror occured, plz try again'});          
        })
    } else {
      knex('Screening')
        .insert(data)
        .then(result=>{
          addScrPlw.webContents.send("resultSent", {'msg':'records added'});
        })
        .catch(err=>{
          addScrPlw.webContents.send("resultSent", {'msg':'eror occured, plz try again'});          
        })
...
function runDemo(){
  ...
  ipcMain.on('addDemo', function(event, name){
    knex.insert({yourName: name, client_id: '1234'}).into('tblDemo').then((ret)=>{
      if(ret.length > 0){
        demo.webContents.send('resultSent', ({'msg':'Successfully added'}))
      }
    }).catch((err)=>{
      demo.webContents.send('resultSent', ({'msg':'record not added failed'}))      
    })
   })
  ...
  ipcMain.on('updateDB', function(){
    request('http://localhost:8888/getProvince',function(err, response, body){
      if(err){
        ...
        knex.insert(data[0]).into('tblGeoProvince').then(ret=>{
          console.log(ret);
        })
      }
    })
    request('http://localhost:8888/getDistrict',function(err, response, body){
      if(err){
        ...
        var data = JSON.parse(body);
        knex.insert(data[0]).into('tblGeoDistrict').then(ret=>{
          console.log(ret);
        })
      }
    })
    request('http://localhost:8888/getTehsil',function(err, response, body){
      if(err){
        ...
        var data = JSON.parse(body);
        knex.insert(data[0]).into('tblGeoTehsil').then(ret=>{
          console.log(ret);
        })
      }
    })
    request('http://localhost:8888/getUC',function(err, response, body){
      if(err){
        ...
        var data = JSON.parse(body);
        knex.insert(data[0]).into('tblGeoUC').then(ret=>{
          console.log(ret);
        })
      }
    })
    request('http://localhost:8888/getSite',function(err, response, body){
      if(err){
        ...
        var data = JSON.parse(body);
        knex.insert(data[0]).into('tblGeoNutSite').then(ret=>{
          console.log(ret);
        })
      }
    })
