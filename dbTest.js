...
module.exports.scrPlwNewReport= function (cond, callback){
  if(!cond){
    knex.select(knex.raw(`SUM(total_scr_pragnent + total_scr_lactating) as total_scr,
      ...
      sum(ifa_tabs_rec_pragnent + ifa_tabs_rec_lactating ) as total_ifa_tabs_rec`)).from('v_tblScrPlwFull')
      ...
      .sum({ifa_tabs_rec_pragnent:'ifa_tabs_rec_pragnent'})
      .sum({ifa_tabs_rec_lactating:'ifa_tabs_rec_lactating'})
